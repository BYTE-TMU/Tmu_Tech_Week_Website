        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-20 lg:gap-32 items-center">
          ...
          <div className="flex items-center gap-8 justify-center md:justify-start">
            <img
              ...
              className="h-24 md:h-28 lg:h-32 w-auto flex-shrink-0"
            />
            <div className="flex flex-col font-notch text-white text-3xl md:text-4xl lg:text-5xl font-bold leading-none">
              <span>TMU</span>
              <span>Tech</span>
              <span>Week</span>
            </div>
          ...
          <div className="text-center space-y-5">
            <h3 className="text-white font-medium text-xl md:text-2xl">Contact Us</h3>
            <a
              href="mailto:tmutechweek@gmail.com"
              className="inline-flex items-center gap-2 text-white/90 hover:text-white transition-colors group relative text-base md:text-lg"
            >
              ...
              <HiArrowUpRight className="w-5 h-5 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
            </a>
          </div>

          {/* Right: Follow Us - Social Icons */}
          <div className="flex flex-col items-center md:items-end gap-5">
            <h3 className="text-white font-medium text-xl md:text-2xl">Follow Us</h3>
